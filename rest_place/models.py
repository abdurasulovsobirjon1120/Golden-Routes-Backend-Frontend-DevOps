...
from historical_places.models import Country, Region  # Import existing models
...
class Favourite(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="rest_favourites")
    place = models.ForeignKey(RestPlace, on_delete=models.CASCADE, related_name="rest_favourites")
